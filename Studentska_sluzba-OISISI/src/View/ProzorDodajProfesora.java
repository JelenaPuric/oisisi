...
import Kontroleri.DugmeOdustaniProfesorKontroler;
import Kontroleri.DugmePotvrdiProfesoraKontroler;
...
public class ProzorDodajProfesora extends JFrame{
	...
	public static ProzorDodajProfesora getInstance() 
	{
		if(instance==null) 
		{
			...
			instance=new ProzorDodajProfesora();
		}
		return instance;
		
	}
	
	public ProzorDodajProfesora() 
	{
		...
		btnPotvrdi= new JButton(new DugmePotvrdiProfesoraKontroler());
		btnOdustani= new JButton(new DugmeOdustaniProfesorKontroler());
